...
class _SingleStockSceenState extends State<SingleStockSceen>
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                SingleNewsScreen(companyId: widget.companyId),
                SingleInsiderScreen(companyId: widget.companyId)
              ],
            ),
          )
        ],
  ...
  // Widget singleNewsScreen() {
  //   return Container();
  // }
  //
  // Widget singleInsiderScreen() {
  //   return Container();
  // }
}
...
class SingleNewsScreen extends StatefulWidget {
  ...
  const SingleNewsScreen({Key? key, required this.companyId}) : super(key: key);
                                  ...
                                  Row(
                                    children: [
                                      InkResponse(
                                        ...
                                        child: Icon(
                                          response.data!.docs![index].isLiked ==
                                                  true
                                              ? Icons.favorite
...
class SingleInsiderScreen extends StatefulWidget {
  final String companyId;
  const SingleInsiderScreen({Key? key, required this.companyId})
      : super(key: key);
                    ...
                    Container(
                      ...
                      child: DataTable(
                        ...
                        border: TableBorder.symmetric(
                            inside:
                                BorderSide(width: 1, color: Color(0xffD1CDCD)),
                            outside:
                                BorderSide(width: 1, color: Color(0xffD1CDCD))),
                        columns: [
                          DataColumn(
                        ...
                        rows: List.generate(
                            ...
                            (indexRow) => DataRow(selected: false, cells: [
                                  DataCell(Text(
